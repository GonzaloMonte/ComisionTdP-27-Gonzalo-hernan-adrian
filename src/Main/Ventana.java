			...
			for(int j=0 ; j<celdas[0].length ; j++) {
				...
				celdas[i][j].setIcon(new ImageIcon("C:/Users/Alumno/git/ComisionTdP-27-Gonzalo-hernan-adrian/src/img/"+mapa.queCeldaEs(i,j)+".jpg"));
					...
					if((i==5 && j==19)||(i==27 && j==6)){
						celdas[i][j].setIcon(new ImageIcon("C:/Users/Alumno/git/ComisionTdP-27-Gonzalo-hernan-adrian/src/img/BarreraHI.png"));}
					else
						if((i==5 && j==20) || (i==27 && j==7)){
							celdas[i][j].setIcon(new ImageIcon("C:/Users/Alumno/git/ComisionTdP-27-Gonzalo-hernan-adrian/src/img/BarreraHC.png"));}
						else
							if((i==27 && j==8)||(j==21 && i==5)){
								celdas[i][j].setIcon(new ImageIcon("C:/Users/Alumno/git/ComisionTdP-27-Gonzalo-hernan-adrian/src/img/BarreraHD.png"));}
				
					if(j==9 || j==18)
						if(i==8)	
							celdas[i][j].setIcon(new ImageIcon("C:/Users/Alumno/git/ComisionTdP-27-Gonzalo-hernan-adrian/src/img/BarreraVAb.png"));
						else
							if(i==7)
								celdas[i][j].setIcon(new ImageIcon("C:/Users/Alumno/git/ComisionTdP-27-Gonzalo-hernan-adrian/src/img/BarreraVC.png"));
							else
								if(i==6)
									celdas[i][j].setIcon(new ImageIcon("C:/Users/Alumno/git/ComisionTdP-27-Gonzalo-hernan-adrian/src/img/BarreraVAr.png"));
